...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Centralized Digital Health Platform
      HOME</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Centralized Digital Health Platform </a>
                ...
                document.getElementById('doctor1').value = document.querySelector(`[value=${values}]`).getAttribute('data-value');
                  ...
                  <div class="col-md-8">
                    ...
                    <select name="apptime" class="form-control" id="apptime" required="required">
                      ...
                      <option value="08:00:00">8:00 - 09.59 AM</option>
                      <option value="10:00:00">10:00 - 11.59 AM</option>
                      <option value="12:00:00">12:00 - 1.59 PM</option>
                      <option value="14:00:00">2:00 - 3.59 PM</option>
                      <option value="16:00:00">4:00- 5.59 PM</option>
                    </select>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel.php?ID=" 
                              ...
                              <input type = "submit" onclick="alert('Bill Paid Successfully');" name ="generate_bill" class = "btn btn-success" value="View Prescription"/>
                              </a>
                              </td>
                              </form>
