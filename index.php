...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>HealthcareLinked: A Blockchain based Digital Health Record Platform</h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="index.php" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>Sign In/Sign Up</h6></a>
          </li>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="Date of Birth" class="form-control" placeholder="Date of Birth *" name="Date of Birth"  />
                                        </div>
                                        <div class="form-group">
                                            <input type="Height" class="form-control" placeholder="Height *" name="Height"  />
                                        </div>
                                        <div class="form-group">
                                            <input type="Weight" class="form-control" placeholder="Weight *" name="Weight"  />
                                        </div>
                            ...
                            <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="BMDC Certificate No:" class="form-control" placeholder="BMDC Certificate No: *" name="BMDC Certificate No:"  />
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="submit" class="btnRegister" name="patsub1" onclick="" value="Register"/>
                                    </div>
