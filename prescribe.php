...
<body style="padding-top:50px;">
   ...
   <div class="tab-pane" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
        <form class="form-group" name="prescribeform" method="post" action="prescribe.php">
          ...
          <div class="col-md-4"><label>Symptoms:</label></div>
                  <div class="col-md-8">
                  <!-- <input type="text" class="form-control" name="symptoms" required> -->
                  <textarea id="disease" cols="86" rows ="5" name="symptoms" required></textarea>
                  </div><br><br><br>
                  ...
                  <textarea id="disease" cols="86" rows ="5" name="diagnosis" required></textarea>
                  </div><br><br><br>
